...
{
    [DbContext(typeof(Assignment9Context))]
    partial class Assignment9ContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Assignment9.Entities.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateofBirth = new DateTimeOffset(new DateTime(1991, 3, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 1, 0, 0, 0)),
                            FirstName = "Akinkunmi",
                            LastName = "Olawale",
                            MainCategory = "Ships"
                        },
                        new
                        {
                            ...
                            DateofBirth = new DateTimeOffset(new DateTime(1990, 12, 23, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 1, 0, 0, 0)),
                            FirstName = "Abiola",
                            LastName = "Abdulahi",
                            MainCategory = "Run"
                        },
                        new
                        {
                            ...
                            DateofBirth = new DateTimeOffset(new DateTime(1996, 5, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 1, 0, 0, 0)),
                            FirstName = "John",
                            LastName = "Lawal",
            ...
            modelBuilder.Entity("Assignment9.Entities.Course", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Assignment9.Entities.Course", b =>
                {
                    b.HasOne("Assignment9.Entities.Author", "Author")
                        .WithMany("Courses")
