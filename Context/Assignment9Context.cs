...
namespace Assignment9.Context
{
    public class Assignment9Context : DbContext
    {
        public Assignment9Context(DbContextOptions<Assignment9Context> options) : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Author>().HasData(
                new Author()
                {
                    ...
                    FirstName = "Akinkunmi",
                    LastName = "Olawale",
                    DateofBirth = new DateTime(1991, 3, 20),
                    MainCategory = "Ships"
                },
                new Author()
                {
